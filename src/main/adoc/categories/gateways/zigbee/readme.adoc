...
* link:https://www.zigbee2mqtt.io/devices/RTCGQ01LM.html[Motion Sensor]
Hold reset for about 5s
...
Press and hold for 5 seconds (link:https://support.sonoff.tech/swv-usermanual/[User Manual])

.Shelly
* link:https://www.zigbee2mqtt.io/devices/WS90.html[Shelly - Ecowitt WS90]
Press 2 times the calibration button

.Heiman
* link:https://www.zigbee2mqtt.io/devices/HS1SA.html[Heiman - Smoke detector]
Hold reset for 5s
...
* link:https://github.com/devbis/z03mmc[Xiaomi LYWSD03MMC Zigbee Firmware] and link:https://www.auto-domo.fr/convertir-vos-thermometres-xiaomi-en-zigbee/[French doc]